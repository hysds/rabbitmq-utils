...
RABBITMQ_QUEUE_INFO_PY="${BASE_PATH}/rabbitmq_queue_info.py"
...
while true; do
    ...
    ${RABBITMQ_QUEUE_INFO_PY} --endpoint="${RABBITMQ_API_ENDPOINT}" --username="${RABBITMQ_USERNAME}" --passwd="${RABBITMQ_PASSWD}" | grep -v celery | while read LINE; do
        ...
        echo "${TIMESTAMP} , ${RABBITMQ_API_ENDPOINT} , rabbitmq , ${RABBITMQ_QUEUE} , state, ${RABBITMQ_STATE} "
        echo "${TIMESTAMP} , ${RABBITMQ_API_ENDPOINT} , rabbitmq , ${RABBITMQ_QUEUE} , ready, ${RABBITMQ_READY} "
        echo "${TIMESTAMP} , ${RABBITMQ_API_ENDPOINT} , rabbitmq , ${RABBITMQ_QUEUE} , unacked, ${RABBITMQ_UNACKED} "
    done
